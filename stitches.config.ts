...
export const globalStyles = globalCss({
    ...
    h1: { fontSize: "$1", fontFamily: 'San Francisco, Helvetica, Arial, sans-serif', },
    h2: { fontSize: "$2", fontFamily: 'San Francisco, Helvetica, Arial, sans-serif', },
    h3: { fontSize: "$3", fontFamily: 'San Francisco, Helvetica, Arial, sans-serif', },
    h4: { fontSize: "$4", fontFamily: 'San Francisco, Helvetica, Arial, sans-serif', },
    h5: { fontSize: "$5", fontFamily: 'San Francisco, Helvetica, Arial, sans-serif', },
    p: { fontSize: "$p" },
    span: { fontSize: "$p" },
    b: {
        fontWeight: "$max",
    ...
    "@font-face": [
        {
            ...
            fontWeight: "300",
            src: 'local("SFUIText-Regular"), url("/fonts/SFUIText-Regular.woff2")',
        },
        {
            fontFamily: "San Francisco",
            fontWeight: "100",
            src: 'local("SFUIText-Light"), url("/fonts/SFUIText-Light.woff2")',
        },
    ],
});
